              ...
              children: [
                TableRow(
                  children: [
                    ...
                    TableCell(child: Container(height:50.h, child: Center(child: Text('당첨번호')))),
                  ],
                ),
                ...List.generate(
                                    ...
                                    child: Row(
                                      ...
                                      children: List.generate(
                                        7,
                                            (indexs) {
                                          // 다음 숫자 값
                                          final nextValue = controller.list[index].getLists()[
                                          (indexs + 1) % controller.list[index].getLists().length];

                                          // 현재 숫자 값
                                          final currentValue = controller.list[index]
                                              .getLists()[indexs];

                                          // 이전 숫자 값
                                          final previousValue = (indexs==0)? 100 :controller.list[index].getLists()[indexs-1];


                                          bool condition = currentValue+1 == nextValue || previousValue+1 == currentValue ;
                                          return Expanded(
                                            flex: 1,
                                            child: Container(
