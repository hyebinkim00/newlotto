...
class VerticalBarchart2 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => VerticalBarchart2State();
}

class VerticalBarchart2State extends State<VerticalBarchart2> {
  late double width;
